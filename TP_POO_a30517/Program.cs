...
namespace TP_POO_a30517
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            Nurse nurse = new Nurse("Joana Silva Ferreira", new DateOnly(1978, 10, 10), "1234555", "987654321", "testeteste.pt", "Rua de Viena 40", "Portuguesa", Roles.Enfermeiro, TeamType.INEM, PersonStatus.Disponível, "Joana Silva", "12345", "Pneumologia");
            ...
            // Adicionando profissionais ao gerenciador
            try
            {
